...
namespace Zenject
{
    public class ProjectContext : Context
    {
        ...
        [SerializeField]
        ReflectionBakingCoverageModes _editorReflectionBakingCoverageMode = default;

        [SerializeField]
        ReflectionBakingCoverageModes _buildsReflectionBakingCoverageMode = default;

        [SerializeField]
        ZenjectSettings _settings = default;
